...
Timeline.FlexibleHandle = function(frameView){
    ...
    this._topElement = this._setupEventHandle($('<div class="tlEventTopHandle tlFlexibleHandle"><i class="fa fa-arrow-up"></i>aaa</div>'));
    this._downElement = this._setupEventHandle($('<div class="tlEventDownHandle tlFlexibleHandle"><i class="fa fa-arrow-down"></i>bbb</div>'));
};
